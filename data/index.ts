...
export const skills = [
  { name: "HTML", img: "/html.svg", description: "Building semantic and accessible page structures." },
  { name: "CSS", img: "/css.svg", description: "Styling responsive layouts with modern CSS techniques." },
  { name: "Sass", img: "/sass.svg", description: "Writing clean, reusable, and scalable styles." },
  { name: "Tailwind CSS", img: "/tail.svg", description: "Rapidly building custom designs with utility-first CSS." },
  { name: "Bootstrap", img: "/bootstrap.svg", description: "Creating responsive UI components efficiently." },
  { name: "JavaScript", img: "/js.svg", description: "Adding interactivity and dynamic behavior to applications." },
  { name: "TypeScript", img: "/ts.svg", description: "Building safer and more maintainable codebases." },
  { name: "React", img: "/react.svg", description: "Developing reusable components and modern SPAs." },
  { name: "WordPress", img: "/wordpress.svg", description: "Customizing themes and managing content-driven websites." },
  { name: "Next.js", img: "/next.svg", description: "Building server-side rendered and static web applications." },
];
