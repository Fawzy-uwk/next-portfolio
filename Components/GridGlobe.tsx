...
export function GridGlobe() {
    ...
    return (
        <div className="flex items-center justify-center w-full h-full absolute inset-0 top-36 md:top-40  -left-5  md:-left-6  lg:-left-6 pointer-events-none select-none z-0">
